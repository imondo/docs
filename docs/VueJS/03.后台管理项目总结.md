...
具体可[查看](https://github.com/one-pupil/vue-template/blob/master/src/store/modules/permission.js)
...
## 总结
以上都是后台系统中可以用到的一些处理方式，具体代码可[查看](https://github.com/one-pupil/vue-template)。

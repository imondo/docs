import{_ as s,c as n,o as a,a as e}from"./app.3f44cf72.js";const h=JSON.parse('{"title":"Vue使用过程小记（持续更新）","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/04_使用过程小记.md","lastUpdated":1676614967000}'),l={name:"guide/04_FRONTEND/1111_Vue/04_使用过程小记.md"},p=e(`<h1 id="vue使用过程小记-持续更新" tabindex="-1">Vue使用过程小记（持续更新） <a class="header-anchor" href="#vue使用过程小记-持续更新" aria-hidden="true">#</a></h1><h2 id="指令" tabindex="-1">指令 <a class="header-anchor" href="#指令" aria-hidden="true">#</a></h2><ul><li>v-bind可以绑定对象</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">&lt;!-- 绑定一个有属性的对象 --&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="利用函数来传递数据有奇效" tabindex="-1">利用函数来传递数据有奇效 <a class="header-anchor" href="#利用函数来传递数据有奇效" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 表格是否可以勾选判断条件</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  ...</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ul><li><code>dispatch</code>最多就只接受两个参数，<code>type</code>和<code>payload</code></li></ul><p>传递第三个，为<code>undefined</code></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">dispatch(&#39;AddRoutesIndex&#39;, {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="elementui中el-tabs组件中el-table的宽度问题" tabindex="-1">ElementUI中el-tabs组件中el-table的宽度问题 <a class="header-anchor" href="#elementui中el-tabs组件中el-table的宽度问题" aria-hidden="true">#</a></h2><p>在tabs使用table会出现滚动条遮住内容可以使用<code>v-if</code>控制<code>el-tab-pane</code>里的内容 例如<code>v-if=&quot;activeName === &#39;second&#39;&quot;</code></p><h2 id="通过跨域方式获取信息" tabindex="-1">通过跨域方式获取信息 <a class="header-anchor" href="#通过跨域方式获取信息" aria-hidden="true">#</a></h2><p>项目<code>token.html</code>引入<a href="https://github.com/zendesk/cross-storage" target="_blank" rel="noreferrer">cross-storage</a>可以跨域获取信息</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// utils/auth.js</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="refreshtoken获取方案" tabindex="-1">RefreshToken获取方案 <a class="header-anchor" href="#refreshtoken获取方案" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// /config/fetch.js</span></span>
<span class="line"><span style="color:#A6ACCD;">...</span></span>
...
<span class="line"><span style="color:#A6ACCD;">        ...</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,19),o=[p];function t(c,i,r,C,A,d){return a(),n("div",null,o)}const y=s(l,[["render",t]]);export{h as __pageData,y as default};

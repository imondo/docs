import{_ as s,c as n,o as a,a as l}from"./app.6870fa24.js";const C=JSON.parse('{"title":"简单的一个VueStore","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/07_简单的一个Store.md","lastUpdated":1673947703000}'),p={name:"guide/04_FRONTEND/1111_Vue/07_简单的一个Store.md"},o=l(`<h1 id="简单的一个vuestore" tabindex="-1">简单的一个VueStore <a class="header-anchor" href="#简单的一个vuestore" aria-hidden="true">#</a></h1><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-palenight"><code><span class="line"></span>

import{_ as s,c as n,o as a,a as l}from"./app.1805c7d6.js";const d=JSON.parse('{"title":"工作中使用的命令集（持续更新）","description":"","frontmatter":{},"headers":[],"relativePath":"guide/10_TOOLS/05_xshell命令.md","lastUpdated":1675155362000}'),p={name:"guide/10_TOOLS/05_xshell命令.md"},e=l(`<h1 id="工作中使用的命令集-持续更新" tabindex="-1">工作中使用的命令集（持续更新） <a class="header-anchor" href="#工作中使用的命令集-持续更新" aria-hidden="true">#</a></h1><h2 id="nginx" tabindex="-1">nginx <a class="header-anchor" href="#nginx" aria-hidden="true">#</a></h2><p><a href="https://www.cnblogs.com/hechunhua/p/4860544.html" target="_blank" rel="noreferrer">find命令</a></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 查找nginx配置文件</span></span>

import{_ as s,c as a,o as n,a as l}from"./app.7fa96445.js";const y=JSON.parse('{"title":"【Vue项目总结】基于饿了么组件封装","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/02_基于饿了么组件封装.md","lastUpdated":1674013329000}'),e={name:"guide/04_FRONTEND/1111_Vue/02_基于饿了么组件封装.md"},p=l(`<h1 id="【vue项目总结】基于饿了么组件封装" tabindex="-1">【Vue项目总结】基于饿了么组件封装 <a class="header-anchor" href="#【vue项目总结】基于饿了么组件封装" aria-hidden="true">#</a></h1><p><code>vue</code>项目中，组件是项目的基石，每个页面都是组件来组装起来，我司没有自己的组件库，选用的是<code>ElementUI</code>组件库，在它的基础上再次封装。</p><h2 id="可编辑表格" tabindex="-1">可编辑表格 <a class="header-anchor" href="#可编辑表格" aria-hidden="true">#</a></h2><p>由于是后台管理项目，各种单据漫天飞，而且单据列表要可编辑，可验证，基于业务所以封装了<a href="https://github.com/imondo/vue-template/blob/master/src/components/page-edit-table/index.vue" target="_blank" rel="noreferrer">可编辑表格组件</a></p><p>业务需求：</p><ol><li><p>每列可以编辑</p></li><li><p>每列输入的值需要被验证</p></li></ol><p>每列可编辑，则需要每列的字段需要一个可编辑的属性<code>edit</code>来确定是否可以编辑，输入的值可以被验证，需要我们传入验证规则。</p><h3 id="确认需要传入的props" tabindex="-1">确认需要传入的<code>props</code> <a class="header-anchor" href="#确认需要传入的props" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">props: {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="表格传入数据后-初始化可编辑状态" tabindex="-1">表格传入数据后，初始化可编辑状态 <a class="header-anchor" href="#表格传入数据后-初始化可编辑状态" aria-hidden="true">#</a></h3><p>阅读<code>el-table</code>源码，可以看到，表格组件拥有自己的<code>store</code>，一些需要通信的状态都是它来维护的，我们也可创建一个自有的<a href="https://github.com/imondo/vue-template/blob/master/src/components/page-edit-table/table-store.js" target="_blank" rel="noreferrer">table-store.js</a>来维护编辑状态</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 初始化数据</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="使用组件" tabindex="-1">使用组件 <a class="header-anchor" href="#使用组件" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">// edit-table.vue</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>

import{_ as s,o as n,c as a,O as l}from"./chunks/framework.7fa419f1.js";const d=JSON.parse('{"title":"【Vue项目总结】后台管理项目总结","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/03_后台管理项目总结.md","filePath":"guide/04_FRONTEND/1111_Vue/03_后台管理项目总结.md","lastUpdated":1686534760000}'),p={name:"guide/04_FRONTEND/1111_Vue/03_后台管理项目总结.md"},e=l(`<h1 id="【vue项目总结】后台管理项目总结" tabindex="-1">【Vue项目总结】后台管理项目总结 <a class="header-anchor" href="#【vue项目总结】后台管理项目总结" aria-label="Permalink to &quot;【Vue项目总结】后台管理项目总结&quot;">​</a></h1><p>公司做的大部分都是后台管理项目，剔除每个项目的业务逻辑，其实都可以用通用的一套模版来做。</p><h2 id="登录逻辑" tabindex="-1">登录逻辑 <a class="header-anchor" href="#登录逻辑" aria-label="Permalink to &quot;登录逻辑&quot;">​</a></h2><p>每个系统都有自己的登录登出逻辑，而我们前端所要做的其实是请求后台，拿到登录权限，带上登录权限，获取用户信息和菜单信息。 在<code>vue</code>项目开发当中，我们一般都是在全局路由钩子做这一系列判断。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">router.beforeEach(async(to, from, next) =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">});</span></span></code></pre></div><p>当用户进入系统的时候，先获取系统的配置信息，这个配置信息可以是前端<code>json</code>文件，或者是后台接口；用这种方式可以灵活的修改项目中的配置，而不用每次都打包死进入项目，直接可以要运维童靴修改对应的配置信息，就可以了。</p><h2 id="菜单权限" tabindex="-1">菜单权限 <a class="header-anchor" href="#菜单权限" aria-label="Permalink to &quot;菜单权限&quot;">​</a></h2><p>以前的菜单路由是直接写死在前端，但是当我们直接访问这个路由时，用户还是可以进入到这个功能页面；后来直接改成动态添加路由的方式<code>router.addRoutes</code>。</p><ol><li>前端先获取菜单列表</li><li>根据获取的菜单列表循环添加用户菜单路由集合</li><li>动态添加路由</li></ol><p>具体可<a href="https://github.com/imondo/vue-template/blob/master/src/store/modules/permission.js" target="_blank" rel="noreferrer">查看</a></p><h2 id="请求方案" tabindex="-1">请求方案 <a class="header-anchor" href="#请求方案" aria-label="Permalink to &quot;请求方案&quot;">​</a></h2><p>项目请求是使用的<code>axios</code>，可以对它添加拦截器来处理我们的请求，也可以处理通过<code>axios.CancelToken</code>重复请求，具体可看代码：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 设置请求统一信息</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    });</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">};</span></span></code></pre></div><p>当需要使用请求时，可以引用文件<code>http.js</code>，也可以挂在到<code>vue</code>原型上，在组件内使用<code>this.$http</code></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// user.js</span></span>
...
<span class="line"><span style="color:#A6ACCD;">Vue.prototype.$http = http;</span></span></code></pre></div><h2 id="按钮loading处理" tabindex="-1">按钮Loading处理 <a class="header-anchor" href="#按钮loading处理" aria-label="Permalink to &quot;按钮Loading处理&quot;">​</a></h2><p>按钮的<code>loading</code>效果可以处理后台响应时间有点长场景，这里使用<code>store</code>封装了下处理方式。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// loading.js</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    store.dispatch(&#39;CancalLoading&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">    ...</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><p>在组件内定义</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;el-button :loading=&quot;btn.save&quot; @click=&quot;handleClick&quot;&gt;保存&lt;/el-button&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p>以上就可以完美的使用<code>loading</code>，而不用每个都在<code>data</code>中定义了。</p><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p>以上都是后台系统中可以用到的一些处理方式，具体代码可<a href="https://github.com/imondo/vue-template" target="_blank" rel="noreferrer">查看</a>。</p><p>其他总结文章：</p><ul><li><a href="https://juejin.im/post/5cf7807d51882519371f2467" target="_blank" rel="noreferrer">webpack常规打包优化方案</a></li><li><a href="https://juejin.im/post/5ce3c9fce51d454d56535754" target="_blank" rel="noreferrer">组件通信处理方案</a></li></ul>`,25),o=[e];function c(t,r,C,A,i,y){return n(),a("div",null,o)}const u=s(p,[["render",c]]);export{d as __pageData,u as default};

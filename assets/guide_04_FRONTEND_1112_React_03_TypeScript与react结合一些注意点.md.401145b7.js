import{_ as s,c as n,o as a,a as l}from"./app.3f44cf72.js";const D=JSON.parse('{"title":"TypeScript与react结合一些注意点（持续更新）","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1112_React/03_TypeScript与react结合一些注意点.md","lastUpdated":1676614967000}'),p={name:"guide/04_FRONTEND/1112_React/03_TypeScript与react结合一些注意点.md"},e=l(`<h1 id="typescript与react结合一些注意点-持续更新" tabindex="-1">TypeScript与react结合一些注意点（持续更新） <a class="header-anchor" href="#typescript与react结合一些注意点-持续更新" aria-hidden="true">#</a></h1><h2 id="dom元素的选择" tabindex="-1">DOM元素的选择 <a class="header-anchor" href="#dom元素的选择" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const body: HTMLElement = document.body;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="scroll滚动事件的绑定" tabindex="-1">scroll滚动事件的绑定 <a class="header-anchor" href="#scroll滚动事件的绑定" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">constructor(props: any) {</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// layout.tsx</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">...</span></span>
<span class="line"><span style="color:#A6ACCD;">public render() {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  );</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,14),o=[e];function t(c,r,i,C,A,d){return a(),n("div",null,o)}const h=s(p,[["render",t]]);export{D as __pageData,h as default};

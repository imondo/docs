import{_ as s,o as n,c as a,O as l}from"./chunks/framework.7fa419f1.js";const d=JSON.parse('{"title":"小程序的初次遇见,使用mpvue搭建模板","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1113_微信端/02_小程序mpvue搭建模板.md","filePath":"guide/04_FRONTEND/1113_微信端/02_小程序mpvue搭建模板.md","lastUpdated":1686534760000}'),e={name:"guide/04_FRONTEND/1113_微信端/02_小程序mpvue搭建模板.md"},p=l(`<h1 id="小程序的初次遇见-使用mpvue搭建模板" tabindex="-1">小程序的初次遇见,使用mpvue搭建模板 <a class="header-anchor" href="#小程序的初次遇见-使用mpvue搭建模板" aria-label="Permalink to &quot;小程序的初次遇见,使用mpvue搭建模板&quot;">​</a></h1><p>由于公司业务需求的需要，在这一周需要开发小程序，加急看了下小程序的文档，发现用其原生来编写程序不是很顺手，公司前端用的技术栈是<code>vue</code>， 询问了谷哥和度娘发现大部分推荐了 <code>wepy</code>和 <code>mpvue</code>，对比了两个框架，还是选用了 <a href="http://mpvue.com/mpvue/#_1?_blank" target="_blank" rel="noreferrer">mpvue</a>, 因为 <code>mpvue</code> 继承自 <code>vue.js</code>，其技术规范和语法特点与 <em><strong>Vue.js</strong></em> 保持一致。</p><h2 id="快速搭建-mpvue-目录" tabindex="-1">快速搭建 <em><strong>mpvue</strong></em> 目录 <a class="header-anchor" href="#快速搭建-mpvue-目录" aria-label="Permalink to &quot;快速搭建 ***mpvue*** 目录&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 全局安装 vue-cli</span></span>
...
<span class="line"><span style="color:#A6ACCD;">$ npm run dev</span></span></code></pre></div><p>一个简单的工程目录就搭建完成了。</p><h2 id="封装自己的公用模块" tabindex="-1">封装自己的公用模块 <a class="header-anchor" href="#封装自己的公用模块" aria-label="Permalink to &quot;封装自己的公用模块&quot;">​</a></h2><h3 id="_1-封装totast" tabindex="-1">1.封装<code>Totast</code> <a class="header-anchor" href="#_1-封装totast" aria-label="Permalink to &quot;1.封装\`Totast\`&quot;">​</a></h3><p>由于小程序原生的消息提示实在是让人崩溃，所以我们先自己来封装下 <code>totast</code>， 在 <code>util</code>目录新建 <code>totast.js</code></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">class toast {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">export default toast</span></span></code></pre></div><p>我们挂载到<em><strong>main.js</strong></em>中， 在组件里可以方便调用</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">import toast from &#39;./utils/toast&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">Vue.prototype.$totast = toast</span></span></code></pre></div><h3 id="_2-封装-publicrequest" tabindex="-1">2.封装 <code>publicRequest</code> <a class="header-anchor" href="#_2-封装-publicrequest" aria-label="Permalink to &quot;2.封装 \`publicRequest\`&quot;">​</a></h3><p>小程序的网路请求不是很方便，我们也对其封装一下。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">import totast from &#39;./toast&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">export default publicRequest</span></span></code></pre></div><p>我们呢也对其挂载到 <code>vue</code> 上去。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">import publicRequest from &#39;./utils/publicRequest&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">Vue.prototype.$http = publicRequest</span></span></code></pre></div><h3 id="_3-扫一扫的调用" tabindex="-1">3.扫一扫的调用 <a class="header-anchor" href="#_3-扫一扫的调用" aria-label="Permalink to &quot;3.扫一扫的调用&quot;">​</a></h3><p>我们先公用出扫一扫</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const handleScan = function () {</span></span>
<span class="line"><span style="color:#A6ACCD;">  return new Promise((resolve, reject) =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">.icon-hebingxingzhuang:after { content: &quot;\\e61a&quot;; }</span></span></code></pre></div><p>就可以使用了。</p><p>现在我们可以愉快的使用其开发了，如果对 <code>vue</code>开发比较熟悉的话，完全迁移过来是没有问题的。最后附上<a href="https://github.com/imondo/wx-mpvue" target="_blank" rel="noreferrer">项目demo</a>和[原文地址][2] 每个人都有第一次，哈哈~这就是我的第一次写文章，不到之处，望指正。</p>`,28),o=[p];function t(c,r,i,C,A,y){return n(),a("div",null,o)}const u=s(e,[["render",t]]);export{d as __pageData,u as default};

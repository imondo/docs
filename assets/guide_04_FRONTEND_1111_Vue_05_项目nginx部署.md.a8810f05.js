import{_ as s,c as n,o as a,a as e}from"./app.72bf9abe.js";const y=JSON.parse('{"title":"【Vue项目总结】项目nginx部署","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/05_项目nginx部署.md","lastUpdated":1671517796000}'),l={name:"guide/04_FRONTEND/1111_Vue/05_项目nginx部署.md"},o=e(`<h1 id="【vue项目总结】项目nginx部署" tabindex="-1">【Vue项目总结】项目nginx部署 <a class="header-anchor" href="#【vue项目总结】项目nginx部署" aria-hidden="true">#</a></h1><p>项目开发完成，接下来是上线，关于<code>vue</code>项目的部署，我司前端是部署在<code>nginx</code>服务器上，关于<code>nginx</code>的相关文档，请自行查阅；本文只记录部署时碰到的一些问题。</p><h2 id="打包" tabindex="-1">打包 <a class="header-anchor" href="#打包" aria-hidden="true">#</a></h2><p><code>vue</code>项目打包后，是生成一系列的静态文件，包括项目的请求<code>IP</code>都打入包内，如果后台服务改动，这时你的前端文件，又要重新编译打包，这里采用的是<a href="https://juejin.im/post/5cedfea96fb9a07ef06f761e#heading-0" target="_blank" rel="noreferrer">后台管理项目总结</a>提到的前端自行请求一个配置文件，动态修改你的相关配置。</p><ul><li>静态文件</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">// config.json</span></span>

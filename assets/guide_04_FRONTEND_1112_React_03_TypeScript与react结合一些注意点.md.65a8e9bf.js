import{_ as s,o as n,c as a,O as l}from"./chunks/framework.7fa419f1.js";const u=JSON.parse('{"title":"TypeScript与react结合一些注意点（持续更新）","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1112_React/03_TypeScript与react结合一些注意点.md","filePath":"guide/04_FRONTEND/1112_React/03_TypeScript与react结合一些注意点.md","lastUpdated":1686534760000}'),p={name:"guide/04_FRONTEND/1112_React/03_TypeScript与react结合一些注意点.md"},e=l(`<h1 id="typescript与react结合一些注意点-持续更新" tabindex="-1">TypeScript与react结合一些注意点（持续更新） <a class="header-anchor" href="#typescript与react结合一些注意点-持续更新" aria-label="Permalink to &quot;TypeScript与react结合一些注意点（持续更新）&quot;">​</a></h1><h2 id="dom元素的选择" tabindex="-1">DOM元素的选择 <a class="header-anchor" href="#dom元素的选择" aria-label="Permalink to &quot;DOM元素的选择&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const body: HTMLElement = document.body;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="scroll滚动事件的绑定" tabindex="-1">scroll滚动事件的绑定 <a class="header-anchor" href="#scroll滚动事件的绑定" aria-label="Permalink to &quot;scroll滚动事件的绑定&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">constructor(props: any) {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">export default withRouter&lt;IArticleProps&gt;(ArticleItem);</span></span></code></pre></div><h2 id="路由" tabindex="-1">路由 <a class="header-anchor" href="#路由" aria-label="Permalink to &quot;路由&quot;">​</a></h2><ul><li><p>利用<code>props</code>中<code>children</code>属性来实现路由<code>link</code>跳转</p></li><li><p>利用<code>Loadable</code>来实现按需加载路由</p></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// router.tsx</span></span>
...
<span class="line"><span style="color:#A6ACCD;">)</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">export default RouterMap;</span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// layout.tsx</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">...</span></span>
<span class="line"><span style="color:#A6ACCD;">public render() {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  );</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div>`,14),o=[e];function t(c,r,i,C,A,d){return n(),a("div",null,o)}const D=s(p,[["render",t]]);export{u as __pageData,D as default};

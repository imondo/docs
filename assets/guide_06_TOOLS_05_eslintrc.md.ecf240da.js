import{_ as s,c as n,o as a,a as l}from"./app.62276965.js";const u=JSON.parse('{"title":"eslintrc 文件示例和解释","description":"","frontmatter":{},"headers":[],"relativePath":"guide/06_TOOLS/05_eslintrc.md","lastUpdated":1670837715000}'),p={name:"guide/06_TOOLS/05_eslintrc.md"},o=l(`<h1 id="eslintrc-文件示例和解释" tabindex="-1">eslintrc 文件示例和解释 <a class="header-anchor" href="#eslintrc-文件示例和解释" aria-hidden="true">#</a></h1><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>

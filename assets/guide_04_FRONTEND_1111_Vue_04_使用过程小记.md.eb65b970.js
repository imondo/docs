import{_ as s,c as n,o as a,a as e}from"./app.a57aac40.js";const h=JSON.parse('{"title":"Vue使用过程小记（持续更新）","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/04_使用过程小记.md","lastUpdated":1675070703000}'),l={name:"guide/04_FRONTEND/1111_Vue/04_使用过程小记.md"},p=e(`<h1 id="vue使用过程小记-持续更新" tabindex="-1">Vue使用过程小记（持续更新） <a class="header-anchor" href="#vue使用过程小记-持续更新" aria-hidden="true">#</a></h1><h2 id="指令" tabindex="-1">指令 <a class="header-anchor" href="#指令" aria-hidden="true">#</a></h2><ul><li>v-bind可以绑定对象</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;!-- 绑定一个有属性的对象 --&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="利用函数来传递数据有奇效" tabindex="-1">利用函数来传递数据有奇效 <a class="header-anchor" href="#利用函数来传递数据有奇效" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 表格是否可以勾选判断条件</span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="refreshtoken获取方案" tabindex="-1">RefreshToken获取方案 <a class="header-anchor" href="#refreshtoken获取方案" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// /config/fetch.js</span></span>
<span class="line"><span style="color:#A6ACCD;">...</span></span>

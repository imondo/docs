import{_ as s,c as a,o as n,a as e}from"./app.3f44cf72.js";const h=JSON.parse('{"title":"前端常见下载处理方案","description":"","frontmatter":{},"headers":[],"relativePath":"scheme/01_解决方案/03_前端常见下载处理方案.md","lastUpdated":1676614967000}'),o={name:"scheme/01_解决方案/03_前端常见下载处理方案.md"},l=e(`<h1 id="前端常见下载处理方案" tabindex="-1">前端常见下载处理方案 <a class="header-anchor" href="#前端常见下载处理方案" aria-hidden="true">#</a></h1><p>下载是我们项目中常常会遇到的需求，不同的下载方案能呈现不同的效果，近期归纳下作者系统中用到常见几种下载处理方案</p><h2 id="a标签下载" tabindex="-1">a标签下载 <a class="header-anchor" href="#a标签下载" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">&lt;a href=&quot;test.xlsx&quot; download=&quot;test.txt&quot;&gt;下载&lt;/a&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>表单的下载可以做特殊的<code>传值</code>处理，也可以传入更多的参数；请求方式也多种多样。</p><h2 id="blob流下载" tabindex="-1">Blob流下载 <a class="header-anchor" href="#blob流下载" aria-hidden="true">#</a></h2><p>用上面方式下载处理，当用户点击下载时，前端不能够很好的捕捉到请求的状态，而用<code>Blob</code>我们可以更灵活的来处理不同状态。</p><blockquote><p>Blob 对象表示一个不可变、原始数据的类文件对象。</p></blockquote><p>简单的示例：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const disposition = decodeURI(xhr.getResponseHeader(&#39;Content-Disposition&#39;)); // 文件名处理</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>后端需要设置</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">Access-Control-Expose-Headers: Content-Disposition</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>通过后台返回的数据来判断是否显示错误提示，也可以根据接口不同状态值来显示。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const reader = new FileReader();</span></span>

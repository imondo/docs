import{_ as s,o as n,c as a,O as l}from"./chunks/framework.7fa419f1.js";const d=JSON.parse('{"title":"工作中使用的命令集（持续更新）","description":"","frontmatter":{},"headers":[],"relativePath":"guide/10_TOOLS/05_xshell命令.md","filePath":"guide/10_TOOLS/05_xshell命令.md","lastUpdated":1686534760000}'),p={name:"guide/10_TOOLS/05_xshell命令.md"},e=l(`<h1 id="工作中使用的命令集-持续更新" tabindex="-1">工作中使用的命令集（持续更新） <a class="header-anchor" href="#工作中使用的命令集-持续更新" aria-label="Permalink to &quot;工作中使用的命令集（持续更新）&quot;">​</a></h1><h2 id="nginx" tabindex="-1">nginx <a class="header-anchor" href="#nginx" aria-label="Permalink to &quot;nginx&quot;">​</a></h2><p><a href="https://www.cnblogs.com/hechunhua/p/4860544.html" target="_blank" rel="noreferrer">find命令</a></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 查找nginx配置文件</span></span>
...
<span class="line"><span style="color:#A6ACCD;">chmod a+x test.sh</span></span></code></pre></div><h2 id="tomcat" tabindex="-1">Tomcat <a class="header-anchor" href="#tomcat" aria-label="Permalink to &quot;Tomcat&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 进入目录</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">vim project.properties</span></span></code></pre></div><h2 id="oracle" tabindex="-1">Oracle <a class="header-anchor" href="#oracle" aria-label="Permalink to &quot;Oracle&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">su -oracle</span></span>
...
<span class="line"><span style="color:#A6ACCD;">lsnrctl status</span></span></code></pre></div><h2 id="redis" tabindex="-1">Redis <a class="header-anchor" href="#redis" aria-label="Permalink to &quot;Redis&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 删除缓存文件</span></span>
...
<span class="line"><span style="color:#A6ACCD;">flushall</span></span></code></pre></div><h2 id="solr" tabindex="-1">Solr <a class="header-anchor" href="#solr" aria-label="Permalink to &quot;Solr&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 启动</span></span>
<span class="line"><span style="color:#A6ACCD;">opt/solr-6.4.2/bin</span></span>
<span class="line"><span style="color:#A6ACCD;">./solr start -force</span></span></code></pre></div><h2 id="rabbitmq" tabindex="-1">Rabbitmq <a class="header-anchor" href="#rabbitmq" aria-label="Permalink to &quot;Rabbitmq&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 启动</span></span>
...
<span class="line"><span style="color:#A6ACCD;">./rabbitmq-server &amp;</span></span></code></pre></div><h2 id="其他" tabindex="-1">其他 <a class="header-anchor" href="#其他" aria-label="Permalink to &quot;其他&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Jenkins</span></span>
...
<span class="line"><span style="color:#A6ACCD;">mount -t nfs 192.168.2.216:/opt/nginx /opt/nginx2</span></span></code></pre></div>`,16),o=[e];function c(t,i,r,C,A,y){return n(),a("div",null,o)}const h=s(p,[["render",c]]);export{d as __pageData,h as default};

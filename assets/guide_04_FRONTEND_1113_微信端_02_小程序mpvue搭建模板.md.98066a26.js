import{_ as s,c as n,o as a,a as l}from"./app.ddfa0823.js";const D=JSON.parse('{"title":"小程序的初次遇见,使用mpvue搭建模板","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1113_微信端/02_小程序mpvue搭建模板.md","lastUpdated":1673343212000}'),p={name:"guide/04_FRONTEND/1113_微信端/02_小程序mpvue搭建模板.md"},e=l(`<h1 id="小程序的初次遇见-使用mpvue搭建模板" tabindex="-1">小程序的初次遇见,使用mpvue搭建模板 <a class="header-anchor" href="#小程序的初次遇见-使用mpvue搭建模板" aria-hidden="true">#</a></h1><p>由于公司业务需求的需要，在这一周需要开发小程序，加急看了下小程序的文档，发现用其原生来编写程序不是很顺手，公司前端用的技术栈是<code>vue</code>， 询问了谷哥和度娘发现大部分推荐了 <code>wepy</code>和 <code>mpvue</code>，对比了两个框架，还是选用了 <a href="http://mpvue.com/mpvue/#_1?_blank" target="_blank" rel="noreferrer">mpvue</a>, 因为 <code>mpvue</code> 继承自 <code>vue.js</code>，其技术规范和语法特点与 <em><strong>Vue.js</strong></em> 保持一致。</p><h2 id="快速搭建-mpvue-目录" tabindex="-1">快速搭建 <em><strong>mpvue</strong></em> 目录 <a class="header-anchor" href="#快速搭建-mpvue-目录" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 全局安装 vue-cli</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>我们挂载到<em><strong>main.js</strong></em>中， 在组件里可以方便调用</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">import toast from &#39;./utils/toast&#39;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>我们呢也对其挂载到 <code>vue</code> 上去。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">import publicRequest from &#39;./utils/publicRequest&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">Vue.prototype.$http = publicRequest</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_3-扫一扫的调用" tabindex="-1">3.扫一扫的调用 <a class="header-anchor" href="#_3-扫一扫的调用" aria-hidden="true">#</a></h3><p>我们先公用出扫一扫</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">const handleScan = function () {</span></span>
<span class="line"><span style="color:#A6ACCD;">  return new Promise((resolve, reject) =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>公用出来后挂载到我们的 <code>vue</code> 上后可以在组件里直接调用 <code>this.$handleScan</code>，如</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">methods: {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_4-如何引入iconfont图标" tabindex="-1">4.如何引入<code>iconfont</code>图标 <a class="header-anchor" href="#_4-如何引入iconfont图标" aria-hidden="true">#</a></h3><p>因为小程序的wxss文件的font-face的url不接受http地址作为参数,但可以接受base64,因此需将字体文件下载后,转换为base64，然后引用。 所以我们可以在阿里巴巴图标库下载下来，将<code>iconfont.ttf</code>转换。转换地址：<a href="https://transfonter.org/" target="_blank" rel="noreferrer">https://transfonter.org/</a></p><p>![图片描述][1]</p><p>下载文件后解压得到<code>stylesheet.css</code>文件，将此文件引入到项目。最后写一个公用的样式:</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">.icon:after{</span></span>

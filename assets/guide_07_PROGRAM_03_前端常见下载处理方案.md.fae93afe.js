...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-hidden="true">#</a></h2><p>以上的三种处理方案是我们常见的前端下载简单汇总，方案不同，效果不同，不过还是推荐<code>Blob</code>方式下载，这种处理方式，可以更加灵活的捕捉到不同状态，前端可以更加方便的处理。</p>`,19),t=[l];function p(c,i,r,d,C,A){return a(),n("div",null,t)}const h=s(o,[["render",p]]);export{y as __pageData,h as default};

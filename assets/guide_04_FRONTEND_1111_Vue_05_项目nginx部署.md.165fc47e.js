import{_ as s,o as a,c as n,O as e}from"./chunks/framework.7fa419f1.js";const u=JSON.parse('{"title":"【Vue项目总结】项目nginx部署","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/05_项目nginx部署.md","filePath":"guide/04_FRONTEND/1111_Vue/05_项目nginx部署.md","lastUpdated":1686534760000}'),l={name:"guide/04_FRONTEND/1111_Vue/05_项目nginx部署.md"},o=e(`<h1 id="【vue项目总结】项目nginx部署" tabindex="-1">【Vue项目总结】项目nginx部署 <a class="header-anchor" href="#【vue项目总结】项目nginx部署" aria-label="Permalink to &quot;【Vue项目总结】项目nginx部署&quot;">​</a></h1><p>项目开发完成，接下来是上线，关于<code>vue</code>项目的部署，我司前端是部署在<code>nginx</code>服务器上，关于<code>nginx</code>的相关文档，请自行查阅；本文只记录部署时碰到的一些问题。</p><h2 id="打包" tabindex="-1">打包 <a class="header-anchor" href="#打包" aria-label="Permalink to &quot;打包&quot;">​</a></h2><p><code>vue</code>项目打包后，是生成一系列的静态文件，包括项目的请求<code>IP</code>都打入包内，如果后台服务改动，这时你的前端文件，又要重新编译打包，这里采用的是<a href="https://juejin.im/post/5cedfea96fb9a07ef06f761e#heading-0" target="_blank" rel="noreferrer">后台管理项目总结</a>提到的前端自行请求一个配置文件，动态修改你的相关配置。</p><ul><li>静态文件</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// config.json</span></span>
...
<span class="line"><span style="color:#A6ACCD;">      });</span></span>
<span class="line"><span style="color:#A6ACCD;">  });</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="nginx部署" tabindex="-1">nginx部署 <a class="header-anchor" href="#nginx部署" aria-label="Permalink to &quot;nginx部署&quot;">​</a></h2><p>因为<code>vue-router</code>有<code>hash</code>和<code>history</code>不同的两种模式，使用不同的模式，<code>nginx</code>的配置不同，<code>hash</code>模式下，不需要改动，只需要部署你的前端文件就可以了，所以这里只讨论<code>history</code>模式下<code>.conf</code>文件的修改</p><p>访问修改<code>nginx</code>配置文件<code>nginx.conf</code></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">server {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p>修改完成，重启服务访问<code>test.com</code></p><h2 id="部署到子级目录" tabindex="-1">部署到子级目录 <a class="header-anchor" href="#部署到子级目录" aria-label="Permalink to &quot;部署到子级目录&quot;">​</a></h2><p>当我们需要把项目部署到子级目录下时，则需要修改项目的<code>BASE_URL</code>，生成一个子级目录下的绝对访问路径。修改对应的<code>.conf</code>配置文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">server {</span></span>
<span class="line"><span style="color:#A6ACCD;">  listen  80;</span></span>
<span class="line"><span style="color:#A6ACCD;">  server_name  test.com;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>

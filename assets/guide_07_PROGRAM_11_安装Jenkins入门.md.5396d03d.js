import{_ as s,c as n,o as a,a as e}from"./app.7a5de996.js";const A=JSON.parse('{"title":"安装Jenkins入门","description":"","frontmatter":{},"headers":[],"relativePath":"guide/07_PROGRAM/11_安装Jenkins入门.md","lastUpdated":1670917237000}'),l={name:"guide/07_PROGRAM/11_安装Jenkins入门.md"},p=e(`<h1 id="安装jenkins入门" tabindex="-1">安装Jenkins入门 <a class="header-anchor" href="#安装jenkins入门" aria-hidden="true">#</a></h1><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h2><p>执行以下命令</p><div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki"><code><span class="line"><span style="color:#676E95;"># 相关依赖</span></span>

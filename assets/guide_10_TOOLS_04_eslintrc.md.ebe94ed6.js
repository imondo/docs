import{_ as s,o as n,c as a,O as l}from"./chunks/framework.7fa419f1.js";const u=JSON.parse('{"title":"eslintrc 文件示例和解释","description":"","frontmatter":{},"headers":[],"relativePath":"guide/10_TOOLS/04_eslintrc.md","filePath":"guide/10_TOOLS/04_eslintrc.md","lastUpdated":1686534760000}'),p={name:"guide/10_TOOLS/04_eslintrc.md"},o=l(`<h1 id="eslintrc-文件示例和解释" tabindex="-1">eslintrc 文件示例和解释 <a class="header-anchor" href="#eslintrc-文件示例和解释" aria-label="Permalink to &quot;eslintrc 文件示例和解释&quot;">​</a></h1><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">      &quot;yoda&quot;: [2, &quot;never&quot;]  </span></span>
<span class="line"><span style="color:#A6ACCD;">    }  </span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span></code></pre></div>`,3),e=[o];function c(t,C,A,r,i,y){return n(),a("div",null,e)}const q=s(p,[["render",c]]);export{u as __pageData,q as default};

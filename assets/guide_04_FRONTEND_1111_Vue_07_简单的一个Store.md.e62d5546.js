import{_ as s,c as n,o as a,a as p}from"./app.72bf9abe.js";const i=JSON.parse('{"title":"简单的一个VueStore","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/07_简单的一个Store.md","lastUpdated":1671535994000}'),l={name:"guide/04_FRONTEND/1111_Vue/07_简单的一个Store.md"},o=p(`<h1 id="简单的一个vuestore" tabindex="-1">简单的一个VueStore <a class="header-anchor" href="#简单的一个vuestore" aria-hidden="true">#</a></h1><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki"><code><span class="line"></span>

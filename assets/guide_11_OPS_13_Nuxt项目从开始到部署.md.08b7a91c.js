import{_ as s,c as n,o as a,a as p}from"./app.44061fed.js";const y=JSON.parse('{"title":"Nuxt项目从开始到部署","description":"","frontmatter":{},"headers":[],"relativePath":"guide/11_OPS/13_Nuxt项目从开始到部署.md","lastUpdated":1671007742000}'),l={name:"guide/11_OPS/13_Nuxt项目从开始到部署.md"},o=p(`<h1 id="nuxt项目从开始到部署" tabindex="-1">Nuxt项目从开始到部署 <a class="header-anchor" href="#nuxt项目从开始到部署" aria-hidden="true">#</a></h1><p>前期接了个私人项目，做个官网，想到在公司都是使用<code>vue</code>技术栈，而官网刚好可以使用<a href="https://zh.nuxtjs.org/guide/installation" target="_blank" rel="noreferrer">nuxt</a>来做。</p><h1 id="开始" tabindex="-1">开始 <a class="header-anchor" href="#开始" aria-hidden="true">#</a></h1><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h2><p><code>nuxt</code>安装可以按照官网的步骤来</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">// 默认安装 create-nuxt-app</span></span>

import{_ as s,c as n,o as a,a as l}from"./app.e8feb119.js";const d=JSON.parse('{"title":"工作中使用的命令集（持续更新）","description":"","frontmatter":{},"headers":[],"relativePath":"guide/06_TOOLS/07_xshell命令.md","lastUpdated":1670894937000}'),p={name:"guide/06_TOOLS/07_xshell命令.md"},e=l(`<h1 id="工作中使用的命令集-持续更新" tabindex="-1">工作中使用的命令集（持续更新） <a class="header-anchor" href="#工作中使用的命令集-持续更新" aria-hidden="true">#</a></h1><h2 id="nginx" tabindex="-1">nginx <a class="header-anchor" href="#nginx" aria-hidden="true">#</a></h2><p><a href="https://www.cnblogs.com/hechunhua/p/4860544.html" target="_blank" rel="noreferrer">find命令</a></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">// 查找nginx配置文件</span></span>

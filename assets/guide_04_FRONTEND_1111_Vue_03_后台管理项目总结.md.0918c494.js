import{_ as s,c as n,o as a,a as l}from"./app.6870fa24.js";const d=JSON.parse('{"title":"【Vue项目总结】后台管理项目总结","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/03_后台管理项目总结.md","lastUpdated":1673947703000}'),p={name:"guide/04_FRONTEND/1111_Vue/03_后台管理项目总结.md"},e=l(`<h1 id="【vue项目总结】后台管理项目总结" tabindex="-1">【Vue项目总结】后台管理项目总结 <a class="header-anchor" href="#【vue项目总结】后台管理项目总结" aria-hidden="true">#</a></h1><p>公司做的大部分都是后台管理项目，剔除每个项目的业务逻辑，其实都可以用通用的一套模版来做。</p><h2 id="登录逻辑" tabindex="-1">登录逻辑 <a class="header-anchor" href="#登录逻辑" aria-hidden="true">#</a></h2><p>每个系统都有自己的登录登出逻辑，而我们前端所要做的其实是请求后台，拿到登录权限，带上登录权限，获取用户信息和菜单信息。 在<code>vue</code>项目开发当中，我们一般都是在全局路由钩子做这一系列判断。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">router.beforeEach(async(to, from, next) =&gt; {</span></span>

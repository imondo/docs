import{_ as s,c as n,o as a,a as e}from"./app.c07b7be5.js";const D=JSON.parse('{"title":"安装 Jenkins","description":"","frontmatter":{},"headers":[],"relativePath":"guide/11_OPS/10_安装 Jenkins.md","lastUpdated":1670995541000}'),l={name:"guide/11_OPS/10_安装 Jenkins.md"},p=e(`<h1 id="安装-jenkins" tabindex="-1">安装 Jenkins <a class="header-anchor" href="#安装-jenkins" aria-hidden="true">#</a></h1><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h2><p>执行以下命令</p><div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki"><code><span class="line"><span style="color:#676E95;"># 相关依赖</span></span>

import{_ as s,c as n,o as a,a as e}from"./app.c1f8735d.js";const D=JSON.parse('{"title":"安装 Jenkins","description":"","frontmatter":{},"headers":[],"relativePath":"guide/11_OPS/10_安装 Jenkins.md","lastUpdated":1675251687000}'),l={name:"guide/11_OPS/10_安装 Jenkins.md"},p=e(`<h1 id="安装-jenkins" tabindex="-1">安装 Jenkins <a class="header-anchor" href="#安装-jenkins" aria-hidden="true">#</a></h1><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h2><p>执行以下命令</p><div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 相关依赖</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h2 id="安装jenkins" tabindex="-1">安装Jenkins <a class="header-anchor" href="#安装jenkins" aria-hidden="true">#</a></h2><p><code>jenkins</code>的容器启动后，重要的文件保存在当前电脑，否则容器被损坏或者删除后就找不回这些文件了，准备一个目录作为文件映射，注意文件夹权限问题，本机目录是<code>/usr/local/work/jenkins</code>，并且执行了<code>chmod 777 /usr/local/work/jenkins</code>以确保<code>docker</code>进程有权限读写此目录</p><div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 查看是否占用端口8080</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><blockquote><p>出现<code>Cannot connect to the Docker daemon.</code>问题尝试<code>service docker start</code>重启</p></blockquote><p>访问<code>8080</code>端口</p><p><a href="https://s2.ax1x.com/2020/01/15/lXEqg0.md.png" target="_blank" rel="noreferrer">!如图</a></p><ul><li><p>页面提示密码文件的位置：<code>/var/jenkins_home/secrets/initialAdminPassword</code>，由于已经将<code>/var/jenkins_home</code>目录映射到<code>/usr/local/work/jenkins</code>目录，所以密码文件位置是：<code>/usr/local/work/jenkins/secrets/initialAdminPassword</code></p></li><li><p>安装推荐的插件</p></li></ul><p><img src="https://s2.ax1x.com/2020/01/15/lXVeVe.png" alt="配置"></p><h2 id="docker指令" tabindex="-1">docker指令 <a class="header-anchor" href="#docker指令" aria-hidden="true">#</a></h2><div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">service</span><span style="color:#A6ACCD;"> docker start // 启动docker</span></span>
<span class="line"></span>

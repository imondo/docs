import{_ as s,o as a,c as n,O as l}from"./chunks/framework.7fa419f1.js";const y=JSON.parse('{"title":"【Vue项目总结】基于饿了么组件封装","description":"","frontmatter":{},"headers":[],"relativePath":"guide/04_FRONTEND/1111_Vue/02_基于饿了么组件封装.md","filePath":"guide/04_FRONTEND/1111_Vue/02_基于饿了么组件封装.md","lastUpdated":1686534760000}'),e={name:"guide/04_FRONTEND/1111_Vue/02_基于饿了么组件封装.md"},p=l(`<h1 id="【vue项目总结】基于饿了么组件封装" tabindex="-1">【Vue项目总结】基于饿了么组件封装 <a class="header-anchor" href="#【vue项目总结】基于饿了么组件封装" aria-label="Permalink to &quot;【Vue项目总结】基于饿了么组件封装&quot;">​</a></h1><p><code>vue</code>项目中，组件是项目的基石，每个页面都是组件来组装起来，我司没有自己的组件库，选用的是<code>ElementUI</code>组件库，在它的基础上再次封装。</p><h2 id="可编辑表格" tabindex="-1">可编辑表格 <a class="header-anchor" href="#可编辑表格" aria-label="Permalink to &quot;可编辑表格&quot;">​</a></h2><p>由于是后台管理项目，各种单据漫天飞，而且单据列表要可编辑，可验证，基于业务所以封装了<a href="https://github.com/imondo/vue-template/blob/master/src/components/page-edit-table/index.vue" target="_blank" rel="noreferrer">可编辑表格组件</a></p><p>业务需求：</p><ol><li><p>每列可以编辑</p></li><li><p>每列输入的值需要被验证</p></li></ol><p>每列可编辑，则需要每列的字段需要一个可编辑的属性<code>edit</code>来确定是否可以编辑，输入的值可以被验证，需要我们传入验证规则。</p><h3 id="确认需要传入的props" tabindex="-1">确认需要传入的<code>props</code> <a class="header-anchor" href="#确认需要传入的props" aria-label="Permalink to &quot;确认需要传入的\`props\`&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">props: {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    default: () =&gt; {}</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="表格传入数据后-初始化可编辑状态" tabindex="-1">表格传入数据后，初始化可编辑状态 <a class="header-anchor" href="#表格传入数据后-初始化可编辑状态" aria-label="Permalink to &quot;表格传入数据后，初始化可编辑状态&quot;">​</a></h3><p>阅读<code>el-table</code>源码，可以看到，表格组件拥有自己的<code>store</code>，一些需要通信的状态都是它来维护的，我们也可创建一个自有的<a href="https://github.com/imondo/vue-template/blob/master/src/components/page-edit-table/table-store.js" target="_blank" rel="noreferrer">table-store.js</a>来维护编辑状态</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 初始化数据</span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span></code></pre></div><h3 id="可编辑列edit-table-cell" tabindex="-1">可编辑列<code>edit-table-cell</code> <a class="header-anchor" href="#可编辑列edit-table-cell" aria-label="Permalink to &quot;可编辑列\`edit-table-cell\`&quot;">​</a></h3><p>利用<code>slot</code>插槽来传递编辑状态和验证规则</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;slot v-else :cellState=&quot;cellState&quot; :validateCell=&quot;validateCell&quot;&gt;&lt;/slot&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">...</span></span>
...
<span class="line"><span style="color:#A6ACCD;">      });</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="使用组件" tabindex="-1">使用组件 <a class="header-anchor" href="#使用组件" aria-label="Permalink to &quot;使用组件&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// edit-table.vue</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">      &lt;/template&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;/el-table-column&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">....</span></span></code></pre></div><p>效果如下</p><p><img src="https://s2.ax1x.com/2019/12/08/QdSbCt.gif" alt=""></p><p>具体代码可查看<a href="https://github.com/imondo/vue-template/blob/master/src/components/page-edit-table/index.vue" target="_blank" rel="noreferrer">组件</a></p><h2 id="增删改的树组件" tabindex="-1">增删改的树组件 <a class="header-anchor" href="#增删改的树组件" aria-label="Permalink to &quot;增删改的树组件&quot;">​</a></h2><p><code>el-tree</code>树形组件其实已经支持了<strong>自定义节点内容</strong>，但是我们要在它的基础上改变<strong>节点内容</strong>，这里主要是运用了<code>Vue.set</code>向响应式对象中添加一个属性。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 部分代码</span></span>

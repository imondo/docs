import{_ as s,c as n,o as a,a as p}from"./app.3f44cf72.js";const y=JSON.parse('{"title":"Nuxt项目从开始到部署","description":"","frontmatter":{},"headers":[],"relativePath":"guide/11_OPS/13_Nuxt项目从开始到部署.md","lastUpdated":1676614967000}'),l={name:"guide/11_OPS/13_Nuxt项目从开始到部署.md"},e=p(`<h1 id="nuxt项目从开始到部署" tabindex="-1">Nuxt项目从开始到部署 <a class="header-anchor" href="#nuxt项目从开始到部署" aria-hidden="true">#</a></h1><p>前期接了个私人项目，做个官网，想到在公司都是使用<code>vue</code>技术栈，而官网刚好可以使用<a href="https://zh.nuxtjs.org/guide/installation" target="_blank" rel="noreferrer">nuxt</a>来做。</p><h1 id="开始" tabindex="-1">开始 <a class="header-anchor" href="#开始" aria-hidden="true">#</a></h1><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h2><p><code>nuxt</code>安装可以按照官网的步骤来</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 默认安装 create-nuxt-app</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="使用预处理器" tabindex="-1">使用预处理器 <a class="header-anchor" href="#使用预处理器" aria-hidden="true">#</a></h2><p>项目下直接安装对应的预处理器</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">yarn add less less-loader</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="全局组件" tabindex="-1">全局组件 <a class="header-anchor" href="#全局组件" aria-hidden="true">#</a></h2><p>在<code>plugins</code>文件夹下创建<code>lib-components.js</code>文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">import Vue from &#39;vue&#39;;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>在<code>nuxt.config.js</code>文件中配置</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">...</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  ],</span></span>
<span class="line"><span style="color:#A6ACCD;">  ...</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="挂载全局http请求" tabindex="-1">挂载全局http请求 <a class="header-anchor" href="#挂载全局http请求" aria-hidden="true">#</a></h2><p>如果我们想在全局来做请求，在传统的<code>vue</code>项目中，我们可以在<code>main.js</code>中挂载到原型上，而在<code>nuxt</code>项目上还是通过<code>plugins</code>目录。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 在plugins目录中建立request.js</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="nginx配置" tabindex="-1">nginx配置 <a class="header-anchor" href="#nginx配置" aria-hidden="true">#</a></h2><div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#C792EA;">server</span><span style="color:#A6ACCD;"> {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"></span></code></pre></div><p>启动<code>nginx</code>后可以访问域名看到项目。</p><h2 id="pm2守护进程" tabindex="-1">pm2守护进程 <a class="header-anchor" href="#pm2守护进程" aria-hidden="true">#</a></h2><p>对于线上项目，如果直接通过 <code>node app</code>来启动，如果报错了可能直接停止导致整个服务崩溃，我们可以使用<code>pm2</code>对<code>node</code>进程管理</p><ul><li>安装</li></ul><div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;">npm</span><span style="color:#A6ACCD;"> install pm2 -g</span></span>
<span class="line"></span></code></pre></div><ul><li>项目根目录创建<code>pm2.json</code></li></ul><div class="language-json"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;">[</span></span>
...
<span class="line"></span></code></pre></div><ul><li>启动<code>pm2</code></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cd /opt/deploy/front</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">pm2 start pm2.json</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p><img src="https://user-gold-cdn.xitu.io/2019/9/20/16d4d97a605d4973?w=814&amp;h=77&amp;f=png&amp;s=6230" alt=""></p><ul><li>常用<code>pm2</code>指令</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">pm2 start app.js               # 启动app.js应用程序</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h1 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-hidden="true">#</a></h1><p>整个项目从开始安装到部署上线还是很平滑的，毕竟都是使用的<code>vue</code>技术栈；但是还是有可以优化的空间，该项目不是一个完整的<code>ssr</code>项目，没有很好的运用<code>nuxt</code>特性。</p>`,46),o=[e];function t(c,r,i,C,d,A){return a(),n("div",null,o)}const h=s(l,[["render",t]]);export{y as __pageData,h as default};

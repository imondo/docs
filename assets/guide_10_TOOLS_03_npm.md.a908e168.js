import{_ as s,c as n,o as a,a as p}from"./app.72bf9abe.js";const y=JSON.parse('{"title":"如何发布自己模块包到NPM","description":"","frontmatter":{},"headers":[],"relativePath":"guide/10_TOOLS/03_npm.md","lastUpdated":1671534361000}'),l={name:"guide/10_TOOLS/03_npm.md"},e=p(`<h1 id="如何发布自己模块包到npm" tabindex="-1">如何发布自己模块包到NPM <a class="header-anchor" href="#如何发布自己模块包到npm" aria-hidden="true">#</a></h1><h2 id="创建" tabindex="-1">创建 <a class="header-anchor" href="#创建" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">npm init </span></span>
